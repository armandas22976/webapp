...
export const metadata: Metadata = {
  title: 'About - Anon File Share',
  description: 'Learn about Anon File Share and how it works',
};
      ...
      <div className="flex flex-col items-center justify-center gap-8 py-8">
        ...
        <Card className="w-full">
          ...
          <CardContent className="space-y-8">
            <p>
              Anon File Share is designed to make sharing files easy, secure, and private. Our platform leverages modern encryption and temporary storage to ensure your files remain protected during the sharing process.
            </p>
